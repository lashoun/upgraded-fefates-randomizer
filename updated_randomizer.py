...
class FatesRandomizer:
    ...
    def sampleSkills(self, nSkills, className):
        ...
        promotedSkills2 = [33, 34, 37, 38, 42, 43, 48, 61, 62, 63, 65, 66, 67, 68, 69, 70, 75, 79, 80, 81, 82, 83, 84, 97, 98, 103, 111]
        if self.gameRoute == "Revelations":
        ...
        specificSkills = [24, 40, 55, 56, 78, 90, 106, 107, 108, 112, 138, 149, 150, 151, 152, 154] # Inspiring Song (24), Beastbane (40), Life And Death (55), Spendthrift (56), Foreign Princess (78), Quixotic (90), Nobility (106), Future Sight (107), Aptitude (108), Locktouch (112), Paragon (138), Ballistician skills (149->152) and Warp (154)
